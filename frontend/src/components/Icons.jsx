...
// Base SVG wrapper with default attributes for crisp, scalable icons
const BaseIcon = ({ size = 18, color = 'currentColor', strokeWidth = 2, className = '', children, ...props }) => (
      <svg
            ...
            className={`cvnex-icon ${className}`}
